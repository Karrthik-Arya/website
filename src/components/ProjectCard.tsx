...
const ProjectCard: FC<ProjectCardProps> = ({title, subtitle, description, url}) => {
    return (<div className="w-full group m-2 p-2 rounded-lg hover:cursor-pointer hover:shadow-lg hover:bg-white/5 hover:backdrop-opacity-5 transition ease-in-out flex flex-col">
        ...
        <p className="transition ease-in-out text-gray-200 opacity-90 text-lg group-hover:text-green-300">
            View Project
        </p>
